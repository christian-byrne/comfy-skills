...
description: 'SaaS retention and churn reduction — cancel flows, dynamic save offers, proactive retention, and dunning for failed payments (voluntary and involuntary churn). Use when reducing churn, designing a cancel or offboarding flow, building save offers, setting up dunning/failed-payment recovery, adding plan pause/downgrade options, or acting on cancellation-reason data.'
...
| Approaching plan limit         | Upgrade nudge (not a hard paywall)                        |
...
Also relevant, if you have the tooling for it: in-app upgrade moments and trial expiration, activation work to prevent early churn, and instrumenting churn signal events in your analytics platform.
