---
name: copy-editing
description: 'Systematic copy editing in focused passes — clarity, concision, voice, flow, and conversion, enhancing existing copy without rewriting the core message. Use when editing or tightening existing marketing copy, running an editing pass on a draft, improving clarity/concision/voice, or polishing conversion copy while preserving its message.'
...
If your project has a shared product marketing context doc (brand voice, ICP, positioning), read it before editing. Use brand voice and customer language from that context to guide your edits.
...
### AI Slop Detection (Sweep 0)

Run this BEFORE the Seven Sweeps. AI-generated copy has structural tells that survive normal editing passes. Full rulesets: `avoid-ai-writing` skill + `avoid-ai-writing` skill (40 pattern categories, 109-entry tiered vocabulary table, context profiles).

- **Throat-clearing openers** — "Here's the thing:", "The uncomfortable truth is", "Let me be clear" → cut, state the point
...
- **False agency** — "the data tells us", "the market rewards" → name the human actor
- **Emphasis crutches** — "Full stop.", "Let that sink in.", "Make no mistake" → delete
- **Metronomic rhythm** — every paragraph ends with a punchy one-liner → vary endings
- **Three-item lists** — "fast, reliable, and powerful" → two items or one
- **Em dashes** → remove; use commas or periods
- **Tier 1 vocabulary** — delve, leverage, robust, seamless, utilize, tapestry, watershed moment → always replace (see **avoid-ai-writing** for full table)
- **Rewrite threshold** — if 5+ vocabulary hits + 3+ pattern categories + uniform rhythm → advise full rewrite, not patching
...
Also relevant, if you have the tooling for it: writing new copy from scratch (use this skill to edit after your first draft is complete), broader page optimization beyond copy, and understanding why certain edits improve conversion.
...
| Task                                  | Approach                                           |
| ------------------------------------- | -------------------------------------------------- |
| Writing new page copy from scratch    | Draft the copy directly, then run this skill on it |
| Reviewing and improving existing copy | copy-editing (this skill)                          |
| Editing copy you just wrote           | copy-editing (this skill)                          |
| Structural or strategic page changes  | Outside this skill's scope — broader page/CRO work |
