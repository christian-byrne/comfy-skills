...
description: 'Pinia store patterns, state management, store setup, and reactivity gotchas. Use when working on Pinia stores, debugging store reactivity, or editing files importing from pinia.'
